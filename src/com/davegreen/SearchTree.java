...
public class SearchTree implements NodeList
{
    ...
    public boolean addItem(ListItem newItem)
    {
        ...
        // We cant actually get to this point but Java will complain if we dont have a return.
    ...
    private void performRemoval(ListItem item, ListItem parent)
    {
        ...
        if(item.next() == null)
        {
            // No right tree, so make parent point to left tree (which may also be null)
        ...
        {
            // no left tree, so make parent point to the right tree (which may also be null)
            ...
            {
                // again we must be looking at the root.
        ...
        else
        {
            ...
            // Now put the smallest value in to our node to be deleted.
